...
const AmericanWing = () => {
  ...
  const exhibitionId = 5;

  /* Code to pull out the data from backend */
 ...
 /* Code for the style of the side bar and everything inside */
  return (
    <>
      <button
      ...
      >
        {/* Had an issue to where we couldnt close the sidepanel. We ended up making a button to back out of it.*/}
        <button
          onClick={() => {
            setShowPanel(false);
        ...
        <h2 style={{ color: '#0dcaf0', marginTop: 0 }}>American Wing</h2>
      ...
      {selectedArtwork && (
        ...
        >
          ...
          <a
            href={`https://www.metmuseum.org/art/collection/search/${selectedArtwork.objectID}`} /* This code is a link to the website of the met museum to the artwork the user has clicked on */
            target="_blank"
